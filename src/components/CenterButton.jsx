  ...
  return (
    <>
      {!connected ? (
        ...
        <button className="flex flex-col items-center px-4 py-2 text-white w-32 rounded-full" onClick={handleStartCall} disabled={isLoading}>
        ...
        //   Turn Off
        // </button>
        <NavItem icon="stop" label="Stop" onClick={endCall} />
      )}
    </>
  );
};
